...
function OnboardingContent() {
  ...
  const handleStep1Submit = async (data: {
    ...
    try {
      clearError();
      const newBusiness = await createBusiness({ business_name: data.business_name, category: data.category });
      let merged = { ...newBusiness, category: data.category as BusinessProfile['category'] };

      // POST /businesses/ only accepts name+category; PATCH with extra fields
      ...
      // Upload hero image as is_hero business photo
      if (data.heroImage) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border border-gray-200 rounded-lg mt-8">
        ...
        <div className="mb-8 text-center">
            ...
            <span className="text-sm font-semibold text-gray-600">{currentStep} / 4</span>
          </div>
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-600">
            ...
            {currentStep === 2 && 'Googleマップから取得した情報を元にしています'}
